...
export class WorkspaceSchemaBootstrap implements OnModuleInit {
  ...
  private async ensureResourceWorkspaceColumns(): Promise<void> {
    await this.dataSource.query(`
      ...
      ADD COLUMN IF NOT EXISTS "notificationEmailLevels" text NOT NULL DEFAULT 'info,warning,critical',
      ADD COLUMN IF NOT EXISTS "notificationTelegramEnabled" boolean NOT NULL DEFAULT true,
      ADD COLUMN IF NOT EXISTS "notificationTelegramLevels" text NOT NULL DEFAULT 'info,warning,critical',
